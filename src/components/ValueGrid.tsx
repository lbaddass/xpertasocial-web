  ...
  return (
    <section className="py-24 border-y border-white/10 bg-grafitoMedium/80">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="font-mono text-xs text-techCyan mb-8 tracking-widest">
        ...
        <div className="grid md:grid-cols-3 gap-px bg-white/5 border border-white/10 rounded-2xl overflow-hidden">
          {values.map((item) => (
            <div
              key={item.title}
              className="bg-grafito/90 p-8 md:p-12 hover:bg-black/60 transition-colors group relative overflow-hidden"
            >
              ...
              <h3 className="text-xl font-bold mb-4 font-sans text-techWhite">
                {item.title}
              </h3>
