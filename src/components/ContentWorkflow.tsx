...
const stages: Stage[] = [
  {
    ...
    description:
      "Competitor_scraper detecta formatos ganadores en TikTok, IG y Shorts.",
    status: "running",
  ...
  },
  {
    ...
    description:
      "Aplica branding y copy master para clonar creatividades sin grabar.",
    status: "queued",
  ...
  },
  {
    ...
    description:
      "Video_renderer produce variaciones optimizadas para cada plataforma.",
    status: "queued",
    icon: <Video size={18} />,
  },
  {
    ...
    description:
      "Landing_generator + auto_publisher despliegan y schedulean contenido.",
    status: "ready",
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          ...
          <p className="text-white/60 font-mono text-xs">
            Hooks listos para MCP servers y n8n.
          </p>
        </div>
...
function StatusPill({ status }: { status: "running" | "queued" | "ready" }) {
  const copy = {
    running: {
      label: "Running",
      className: "text-[#E63946] border-[#E63946]/60",
    },
  ...
  return (
    <span
      className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-mono ${copy.className}`}
    >
