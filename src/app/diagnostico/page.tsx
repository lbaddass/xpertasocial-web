import { ArrowRight, ShieldCheck, Calendar, Mail } from "lucide-react";
    ...
    <div className="min-h-screen pt-20 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 mb-16 text-center">
        ...
        <p className="text-xl text-white/60 max-w-2xl mx-auto font-light">
          Dos caminos para comenzar. Elige el que mejor se adapte a tu etapa actual.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div id="audit" className="bg-carbon border border-white/10 p-8 md:p-12 flex flex-col relative overflow-hidden group hover:border-white/30 transition-all">
            ...
            <div className="mb-8">
              <div className="inline-block px-3 py-1 bg-white/5 border border-white/10 rounded-sm mb-4">
                <span className="text-xs font-mono text-white tracking-widest uppercase">OPCIÓN A: SIN COSTO</span>
              </div>
              <h2 className="text-3xl font-bold text-white mb-4">Auditoría Online Gratuita</h2>
              <p className="text-white/60 leading-relaxed">
                Analizamos tu presencia digital actual para detectar &quot;vulnerabilidades expuestas&quot; y fugas de dinero en tus campañas.
              </p>
            </div>

            <ul className="space-y-4 mb-8 flex-1">
              <li className="flex items-start gap-3 text-sm text-white/80">
                <ShieldCheck size={16} className="text-neonBlue mt-0.5 shrink-0" />
          ...
          <div className="bg-neonBlue text-black p-8 md:p-12 flex flex-col relative overflow-hidden">
            ...
            <div className="mb-8">
              <div className="inline-block px-3 py-1 bg-black/10 border border-black/10 rounded-sm mb-4">
                <span className="text-xs font-mono text-black tracking-widest uppercase">OPCIÓN B: ACCIÓN INMEDIATA</span>
              </div>
              <h2 className="text-3xl font-bold text-black mb-4">Diseñar mi Estrategia</h2>
              <p className="text-black/70 leading-relaxed">
                Sesión estratégica para arquitectar tu crecimiento. Diseñamos la ruta exacta para que impulses tus ventas sin desperdiciar dinero.
              </p>
            </div>
            ...
            <p className="text-xs text-center mt-4 text-black/50">
              * Si nuestra estrategia no mejora tus resultados en el primer mes, tu factura inicial no tendrá costo.
            </p>
          </div>
        </div>
      </div>
