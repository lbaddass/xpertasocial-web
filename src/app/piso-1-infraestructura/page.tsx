  ...
  const services = [
    {
      ...
      features: ["Sitio One-Page de alto impacto", "Estructura de conversión probada", "Entrega Flash 48 horas"],
    ...
    },
    {
      ...
      features: ["Sistema 2 Pasos (Registro + Gracias)", "Pixel Tracking instalado", "Vital para no tirar dinero en Ads"],
    ...
    },
    {
      ...
      features: ["5 Secciones completas", "CRM Básico (Tabla de leads)", "Botón WhatsApp directo"],
    ...
    },
    {
      ...
      features: ["Tienda Online (20 productos)", "Pasarela de Pagos configurada", "Panel autogestionable"],
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-8 border-b border-white/10 pb-12">
          <div className="space-y-4">
            <div className="inline-block px-3 py-1 bg-neonBlue/10 border border-neonBlue/20 rounded-full">
              <span className="text-xs font-mono text-neonBlue tracking-widest uppercase">PISO 1: INFRAESTRUCTURA</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight">
              ACTIVOS <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/50">PROPIOS</span>
            </h1>
            <p className="text-xl text-white/60 max-w-2xl font-light">
              El lugar donde conviertes visitantes en dinero. Pago único, propiedad 100% del cliente.
            </p>
          </div>
          <div className="text-right hidden md:block">
            <div className="text-sm font-mono text-white/40 mb-1">CAPACIDAD DE CARGA</div>
            ...
            >
              ...
              <div className="relative z-10 space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="text-sm font-mono text-white/50">{service.target}</div>
                </div>
                ...
                <ul className="space-y-3">
                  {service.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start gap-3 text-sm text-white/70">
                      <Check size={16} className="text-neonBlue mt-0.5 shrink-0" />
                      {feature}
                    </li>
                  ))}
                </ul>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20">
        <div className="bg-neonBlue text-black p-12 relative overflow-hidden">
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tight">¿No sabes qué infraestructura necesitas?</h2>
              <p className="text-black/70 max-w-xl">
                Realiza nuestro diagnóstico gratuito y te diremos exactamente qué pieza te falta para escalar.
              </p>
            </div>
            <Link
              href="/diagnostico"
